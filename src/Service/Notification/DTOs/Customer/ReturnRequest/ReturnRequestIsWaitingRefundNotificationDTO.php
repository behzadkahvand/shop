...
class ReturnRequestIsWaitingRefundNotificationDTO extends AbstractNotificationDTO
{
    ...
    {
        return NotificationCodeDictionary::RETURN_REQUEST_IS_WAITING_REFUND;
    }

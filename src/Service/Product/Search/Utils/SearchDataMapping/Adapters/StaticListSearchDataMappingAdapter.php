...
/**
 * Class StaticListSearchDataMappingAdapter
 */
class StaticListSearchDataMappingAdapter implements SearchDataMappingInterface
{
    private const MAPPING = [
        WebsiteAreaDictionary::AREA_CUSTOMER => ProductSearchDataMappingDictionary::CUSTOMER_AREA_MAPPING,
        WebsiteAreaDictionary::AREA_SELLER   => ProductSearchDataMappingDictionary::SELLER_AREA_MAPPING,
    ];

...
/**
 * Class CanceledByUserSellerOrderItemStatus
 */
final class CanceledByUserSellerOrderItemStatus extends AbstractSellerOrderItemStatus
{
    ...
    {
        return SellerOrderItemStatus::CANCELED_BY_USER;
    }
}

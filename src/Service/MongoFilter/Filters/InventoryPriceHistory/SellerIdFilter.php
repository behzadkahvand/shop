...
class SellerIdFilter extends AbstractPipelineFilter implements TagAwarePipelineStageInterface
{
    /**
    ...
    protected function doInvoke(FilterPayload $payload)
    {
         return $payload->setQueryBuilder(
             $payload->getQueryBuilder()->field('inventory.seller_id')
    ...
    {
        return "inventory_price.seller_id";
    }
}

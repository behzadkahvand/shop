...
use App\Service\Seller\SellerOrderItem\Status\WaitForSendSellerOrderItemStatus;
use Doctrine\Common\Collections\ArrayCollection;
use Mockery\Adapter\Phpunit\MockeryTestCase;

/**
 * Class WaitForSendSellerOrderItemStatusTest
 */
final class WaitForSendSellerOrderItemStatusTest extends MockeryTestCase
{
    public function testItSupportWaitForSendSellerOrderItemStatus(): void
    {
        $service = new WaitForSendSellerOrderItemStatus(\Mockery::mock(OrderShipmentStatusService::class));

        self::assertTrue($service->support(SellerOrderItemStatus::WAITING_FOR_SEND));
    ...
    public function testItSetSellerOrderItemStatusToStoragedAndDontChangeOrderShipmentStatusToStoraged(): void
    {
        ...
        $service = new WaitForSendSellerOrderItemStatus($orderShipmentStatusService);

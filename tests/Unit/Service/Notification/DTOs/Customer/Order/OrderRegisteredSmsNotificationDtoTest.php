...
class OrderRegisteredSmsNotificationDtoTest extends BaseUnitTestCase
{
    public function testItCanGetCodeSuccessfully(): void
    {
        self::assertEquals(
            NotificationCodeDictionary::CUSTOMER_ORDER_REGISTERED,
            OrderRegisteredSmsNotificationDTO::getCode()
        );
    }
    ...
    public function testItCanGetSectionSuccessfully(): void
    {
        self::assertEquals(
            ...
            OrderRegisteredSmsNotificationDTO::getSection()
        );
    }
    ...
    public function testItCanGetNotificationTypeSuccessfully(): void
    {
        self::assertEquals(
            ...
            OrderRegisteredSmsNotificationDTO::getNotificationType()
        );
    }
    ...
    public function testItCanGetVariablesDescriptionSuccessfully(): void
    {
        self::assertEquals(
            ...
            OrderRegisteredSmsNotificationDTO::getVariablesDescription()
        );
    }
...
TEMPLATE,
            OrderRegisteredSmsNotificationDTO::getDefaultTemplate()
        );
    }
    ...
    public function testItCanRenderTemplateAndGetTheMessageSuccessfully(): void
    {
        ...
        $message = (new OrderRegisteredSmsNotificationDTO($order))->getMessage($templateEngine, 'ABc123');

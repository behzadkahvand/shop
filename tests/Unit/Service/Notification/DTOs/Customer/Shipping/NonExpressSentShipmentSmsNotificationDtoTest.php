...
class NonExpressSentShipmentSmsNotificationDtoTest extends BaseUnitTestCase
{
    public function testItCanGetCodeSuccessfully(): void
    {
        self::assertEquals(
            NotificationCodeDictionary::CUSTOMER_POST_SHIPPING,
            NonExpressSentShipmentSmsNotificationDTO::getCode()
        );
    }
    ...
    public function testItCanGetSectionSuccessfully(): void
    {
        self::assertEquals(
            ...
            NonExpressSentShipmentSmsNotificationDTO::getSection()
        );
    }
    ...
    public function testItCanGetNotificationTypeSuccessfully(): void
    {
        self::assertEquals(
            ...
            NonExpressSentShipmentSmsNotificationDTO::getNotificationType()
        );
    }
    ...
    public function testItCanGetVariablesDescriptionSuccessfully(): void
    {
        self::assertEquals(
            ...
            NonExpressSentShipmentSmsNotificationDTO::getVariablesDescription()
        );
    }
...
TEMPLATE,
            NonExpressSentShipmentSmsNotificationDTO::getDefaultTemplate()
        );
    }
    ...
    public function testItCanRenderTemplateAndGetTheMessageSuccessfully(): void
    {
        ...
        $message = (new NonExpressSentShipmentSmsNotificationDTO($order))->getMessage($templateEngine, 'ABc123');

...
use App\Service\Product\Search\Listeners\Doctrine\ProductAvailabilityEventListener;
...
class ProductAvailabilityEventListenerTest extends MockeryTestCase
{
    ...
    public function testItCanGetSubscribedEvents()
    {
        ...
        self::assertEquals([ProductSearchDataEvent::class => ['onProductSearchQueryEvent', 3]], $result);
    }

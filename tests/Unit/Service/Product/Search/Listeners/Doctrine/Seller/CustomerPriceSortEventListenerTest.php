...
use App\Service\Product\Search\Listeners\Doctrine\Seller\CustomerPriceSortEventListener;
...
class CustomerPriceSortEventListenerTest extends FunctionalTestCase
{
    ...
    public function testItCanSetApplyMaximumPriceSortInSearchDataEvent()
    {
        ...
        $event      = new SellerProductSearchDataEvent(
            ...
            new DoctrineSearchData(
                [],
                ['-visits', '-productVariants.inventories.finalPrice'],
                'category_code',
                'title'
            ),
            $pagination
        ...
        self::assertEquals([
            "field"            => "productVariants.inventories.finalPrice",
            "direction"        => "DESC",
            "direction_prefix" => "-"
    ...
    public function testItDoNothingPriceSortNotSetForSearchQueryEvent()
    {
        ...
        $queryEvent = new SellerProductSearchQueryEvent(
            DoctrineProductSearchDriver::class,

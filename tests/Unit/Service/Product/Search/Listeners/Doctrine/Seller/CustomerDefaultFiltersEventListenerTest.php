...
use App\Service\Product\Search\Listeners\Doctrine\Seller\CustomerDefaultFiltersEventListener;
...
class CustomerDefaultFiltersEventListenerTest extends MockeryTestCase
{
    ...
    public function testItCanGetSubscribedEvents()
    {
        ...
        self::assertEquals([SellerProductSearchDataEvent::class => ['onProductSearchDataEvent', 2]], $result);
    }
    ...
    {
        $event = new SellerProductSearchDataEvent(DoctrineProductSearchDriver::class, new SearchData([], []), new Pagination());
    ...
    {
        $event = new SellerProductSearchDataEvent(DoctrineProductSearchDriver::class, new SearchData([

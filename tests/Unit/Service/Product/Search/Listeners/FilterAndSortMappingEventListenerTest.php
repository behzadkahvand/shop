...
use App\Service\Product\Search\Listeners\FilterAndSortMappingEventListener;
...
final class FilterAndSortMappingEventListenerTest extends BaseUnitTestCase
{
    ...
    {
        self::assertEquals(
            [ProductSearchDataEvent::class => ['onProductSearchData', 110]],
    ...
    public function testItDontProcessEmptyFilterAndSorts(): void
    {
        $listener = new FilterAndSortMappingEventListener(
            ...
            Mockery::mock(StaticListSearchDataMappingAdapter::class)
        );
    ...
    public function testItThrowExceptionIfFilterIsInvalid(): void
    {
        ...
        $mapping = Mockery::mock(StaticListSearchDataMappingAdapter::class);

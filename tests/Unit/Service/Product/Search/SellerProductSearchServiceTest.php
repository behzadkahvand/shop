...
class SellerProductSearchServiceTest extends MockeryTestCase
{
    /**
    ...
    protected SellerProductSearchService $productSearchService;
    ...
    protected function setUp(): void
    {
        ...
        $this->productSearchService = new SellerProductSearchService(
    ...
    public function testItCanSearchProduct()
    {
        $this->dispatcherMock->shouldReceive('dispatch')
                             ->with(Mockery::type(SellerProductSearchDataEvent::class))
                             ->once();

        $this->dispatcherMock->shouldReceive('dispatch')
                             ->with(Mockery::type(SellerProductSearchQueryEvent::class))
                             ->once();

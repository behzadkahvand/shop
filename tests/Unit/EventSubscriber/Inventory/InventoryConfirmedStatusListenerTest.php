...
use App\EventSubscriber\Inventory\InventoryConfirmedStatusListener;
...
class InventoryConfirmedStatusListenerTest extends MockeryTestCase
{
    /**
    ...
    protected InventoryConfirmedStatusListener $inventoryConfirmedStatusListener;
    ...
    protected function setUp(): void
    {
        ...
        $this->inventoryConfirmedStatusListener = new InventoryConfirmedStatusListener($this->em, $this->websiteAreaMock);
    }

    public function testItCanGetSubscribedEvents()
    {
        $result = $this->inventoryConfirmedStatusListener::getSubscribedEvents();
    ...
    public function testItDoNothingWhenRequestIsNotMaster()
    {
        ...
        self::assertNull($this->inventoryConfirmedStatusListener->onKernelRequest($this->requestEventMock));
    }

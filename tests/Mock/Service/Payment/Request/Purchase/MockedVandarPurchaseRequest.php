...
use App\Service\Payment\Request\Purchase\VandarPurchaseRequest;
use App\Service\Payment\Response\Purchase\AbstractPurchaseResponse;
use App\Service\Payment\Response\Purchase\VandarPurchaseResponse;

/**
 * Class MockedVandarPurchaseRequest
 */
final class MockedVandarPurchaseRequest extends VandarPurchaseRequest
{
    /**
     * @inheritDoc
     */
    public function send(Transaction $transaction, string $callbackUrl): AbstractPurchaseResponse
    {
        ...
        return new VandarPurchaseResponse($status, $token);
    }
}
